function initSupportMobile(doc) {
  ...
  cls(
    messages,
    "flex flex-col items-start justify-center w-full px-4 max-h-[20rem] overflow-scroll mb-3"
  );
  ...
  cls(chat, `min-w-[${width}px] bottom-8 right-0 msg rounded`);
...
function initMobile() {
  d(() => {
    ...
    for (let i = 0; i < matchs.length; ++i) {
      ...
      spanScore.textContent = match.scoreClub
