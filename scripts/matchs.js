...
function setConfig(matchs) {
  ...
  matchs[4].setPlayers([joueurs.VINCENT, joueurs.CEDRIC, joueurs.FRED]);
  matchs[4].setPrevisionnels([joueurs.NATHALIE]);
  matchs[4].setRemplacants([joueurs.YOHAN]);
  matchs[4].setAbsents([
    joueurs.HAMED,
    joueurs.MATHEO,
    joueurs.LEO,
  ...
  matchs[5].setAbsents([joueurs.HAMED, joueurs.MATHEO, joueurs.LEO]);
  ...
  matchs[6].setAbsents([joueurs.MATHEO, joueurs.LEO, joueurs.NATHALIE]);
